...
const createStudy = async (req, res, next) => {
  const bodySchema = Joi.object({
    ...
    region_1depth_name: Joi.string().max(20).required(),
    region_2depth_name: Joi.string().max(20).required(),
...
const studyUpdate = async (req, res, next) => {
  ...
  const bodySchema = Joi.object({
    ...
    region_1depth_name: Joi.string().max(20),
    region_2depth_name: Joi.string().max(20),
